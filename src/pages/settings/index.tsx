                ...
                <Card>
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={invoiceDesign.showLogo ? "show" : "hide"}
                        onValueChange={(value) => setInvoiceDesign({ ...invoiceDesign, showLogo: value === "show" })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="show">Show company logo on invoices</SelectItem>
                          <SelectItem value="hide">Hide company logo</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        value={invoiceDesign.logoPosition}
                        onValueChange={(value) => setInvoiceDesign({ ...invoiceDesign, logoPosition: value })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                    ...
                    <div className="space-y-2">
                      ...
                      <Textarea
                        ...
                        onChange={(e) => setInvoiceDesign({ ...invoiceDesign, footerText: e.target.value })}
                        rows={3}
                    ...
                    <div className="space-y-2">
                      <Label>QR Code Display (ZATCA Compliance)</Label>
                      <Select
                        value={invoiceDesign.showQR ? "show" : "hide"}
                        onValueChange={(value) => setInvoiceDesign({ ...invoiceDesign, showQR: value === "show" })}
                      >
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="show">Show QR code (ZATCA compliant)</SelectItem>
                          <SelectItem value="hide">Hide QR code</SelectItem>
                        </SelectContent>
                      </Select>
                      <p className="text-xs text-muted-foreground">
                        QR code is mandatory for ZATCA e-invoicing compliance
                      </p>
                    </div>

                    <div className="border-t pt-6">
                      <h3 className="text-sm font-semibold mb-4">Preview</h3>
                      <div className="bg-muted p-6 rounded-lg border-2" style={{ borderColor: invoiceDesign.primaryColor }}>
                        <div className="bg-white p-4 rounded shadow-sm">
                          <div className="flex justify-between items-start mb-4">
                            {invoiceDesign.showLogo && (
                              <div className={`text-${invoiceDesign.logoPosition}`}>
                            ...
                            <div className="text-right">
                              <h3 className="font-bold" style={{ color: invoiceDesign.primaryColor }}>INVOICE</h3>
                              <p className="text-xs text-muted-foreground">INV-2026-00001</p>
                            </div>
                          </div>
                          <div className="border-t border-b py-2 my-2">
                            <p className="text-xs text-muted-foreground">Sample invoice items would appear here...</p>
                          </div>
                          <div className="flex justify-between items-center mt-4">
                            {invoiceDesign.showQR && (
                              <div className="w-16 h-16 bg-gray-200 flex items-center justify-center text-xs">
                                QR
                              </div>
                            )}
                            <div className="text-right">
                              <p className="text-xs font-medium">{invoiceDesign.footerText}</p>
                            </div>
                          </div>
                        </div>
                      </div>
